...
# train
train_set = {
        'root': 'python/BraTs2021/BraTS2021_Data',  # 四个模态数据所在地址
        'out': 'python/BraTs2021/Dataset',  # 预处理输出地址
...
def doit(dset):
    ...
    file_list = os.listdir('/home/mansu/Code/python/BraTs2021/BraTS2021_Data')
    paths = [os.path.join(root, name, name + '_' ) for name in file_list if name.split('_')[0] == 'BraTS2021']
